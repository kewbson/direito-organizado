          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex justify-center">
                <button
                    ...
                    // 2. Removido o w-full para que o botão tenha a largura do seu conteúdo
                    className="flex items-center space-x-3 px-3 py-2 rounded-lg
                               text-sidebar-foreground/70 hover:bg-destructive hover:text-destructive-foreground
                               transition-colors duration-200">
                    <LogOut className="h-5 w-5" />
                    <span className="font-medium">Sair</span>
                </button>
              </div>
                <p className="mt-1 text-center text-xs text-sidebar-foreground/60">
            Copyright &copy; 2025 direitoorganizado.com.br</p>
                 <p className="mt-0 text-center text-xs text-sidebar-foreground/60">
            Copyright &copy; 2025 Kewbson Hilário</p>
          </div>
        </div>
      </aside>
    </>
