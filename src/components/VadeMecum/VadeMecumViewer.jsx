...
const VadeMecumViewer = ({ document, onClose, isEmbedded = false }) => {
  ...
  // Layout para modo embedded (split-view)
  if (isEmbedded) {
    return (
      <div className="h-full flex flex-col">
        ...
        <ScrollArea className="flex-1">
          <div className="p-4 space-y-6">
            {/* Metadados */}
            <div className="grid grid-cols-1 gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            {document.palavrasChave && document.palavrasChave.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Palavras-chave:</span>
                </div>
                  ...
                  {document.secoes.map((secao, index) => (
                    <Card key={index} className="border-l-4 border-blue-500">
                      <CardHeader className="pb-2">
                        ...
                        {secao.referencia && (
                          <p className="text-sm text-gray-600 dark:text-gray-400">{secao.referencia}</p>
                        )}
                      </CardHeader>
                      <CardContent>
  ...
  // Layout para modo modal (original)
  return (
